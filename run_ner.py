...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        :return:
        '''
        return ["X", 'O', 'B-Disease', 'I-Disease', 'B-Reason', 'I-Reason', "B-Symptom", "I-Symptom", "B-Test",
                "I-Test",
                "B-Test_Value", "I-Test_Value", "B-Drug", "I-Drug", "B-Frequency", "I-Frequency", "B-Amount",
                "I-Amount",
                "B-Treatment", "I-Treatment", "B-Operation", "I-Operation", "B-Method", "I-Method", "B-SideEff",
                "I-SideEff", "B-Anatomy", "I-Anatomy", "B-Level", "I-Level", "B-Duration", "I-Duration"]
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("loss"):
        ...
        # Tensor("loss/Shape_2:0", shape=(2,), dtype=int32)
...
def get_eval(pred_result, real_labels, label_list, max_seq_length):
    ...
    for i in range(len(predictions)):
        ...
        if len(real) > max_seq_length - 1:
            continue
        real_ = [label_map[k] for k in real.split(" ")]
